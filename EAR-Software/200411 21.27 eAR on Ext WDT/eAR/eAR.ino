 ...
 *  INPUT B - reserved
 *  INPUT C - I/E ratio LSB \_ (Dip switch possible) 11: 1-2 (default, both opened), 00: 1-1 (both closed, GND connected), 
 *  INPUT D - I/E retio MSB /  01: 1-3 (C closed, GND connected, D opened), 10: 1-4 (D closed, GND connected, C opened)
 *  
 *  INPUT E - T_Hold LSB \_ (Dip switch possible) 11: 150ms (default, both opened), 00: 2s (both closed, GND connected), 
 *  INPUT F - T_Hold MSB /  01: 500ms (C closed, GND connected, D opened), 10: 1s (D closed, GND connected, C opened)
 *  
 *  INPUT G - 
 *  INPUT H - 
 *  
