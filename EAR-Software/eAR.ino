...
// leituras das entradas, jÃ¡ em formato final
U16 I_Read;
...
void Dump_HexChar (U8 HexChar)
  {
  if (HexChar<0x10) Serial.print ("0");
...
delay (Ticks); //  10 ms entre cada leitura
...
if (Motor_Peak_Current<Motor_Current) Motor_Peak_Current=Motor_Current;
